...
function ExtrairGeracaoIntel(const NomeCPU: String): Integer; // -1 = nao identificado
...
begin
  ...
  I := Pos1 + 2;
  Digitos := '';
  // pula espacos e hifen entre "i5" e o numero do modelo
...
begin
  ...
  begin
    if Texto[I] in ['0'..'9'] then
      ...
      Break; // pega so o primeiro bloco numerico (ex: "8 GB" -> "8")
  end;
...
begin
  ...
  if
cd /workspaces/pascal-dev/projetos/LogicB0BAnalyser

cat > HardwareRules.pas << 'EOF'
unit HardwareRules;
